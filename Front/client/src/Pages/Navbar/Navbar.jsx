      ...
      >
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <span className="d-flex align-items-center gap-3 justify-content-evenly">
              ...
              {props.isLoggedIn && (
                <Link
                  onClick={() => {
                    handleLinkClick("favourite");
                  }}
                  className={`nav-link ${
                    activeLink === "favourite" ? `${Style.active}` : ""
                  }`}
                  to="/favourite"
                >
                  <svg
              ...
              {props.isLoggedIn && (
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className={`bi bi-person-fill ${Style.avatar}`}
                  viewBox="0 0 16 16"
                >
