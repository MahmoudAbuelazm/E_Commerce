...
const ProductDetails = () => {
  ...
  console.log(
    "🚀 ~ file: ProductDetails.jsx:21 ~ ProductDetails ~ userToken:",
    userToken
  );
    ...
    const getProduct = () => {
      axios
        ...
        .then((resp) => {
          ...
          setfav(resp.data.result.favourite);
        })
        .catch((err) => {
          console.log(err);
        });
                ...
                <span className=" border border-dark p-2 rounded-2">
                  {fav ? (
                    <svg
                      ...
                      viewBox="0 0 16 16"
                      style={{ fill: "var(--main-color)", cursor: "pointer" }}
                    >
                      <path
                        fill-rule="evenodd"
