        ...
        <>
            <div className='container py-3  my-4'>
                ...
                <div className="row flex-column flex-md-row py-4 justify-content-around">
                    <div id={style.contain} className="col-12 col-md-4 px-5 py-3 text-white rounded-4">
                        <div className="py-3">
                            <div className="d-flex gap-3 my-3 align-items-center text-white">
                    ...
                    <div id={style.contain} className="col-12 col-md-7 mt-3 mt-md-0 rounded-4">
